<%@ Page Title="" Language="C#" MasterPageFile="~/Pags/MasterPage.master" AutoEventWireup="true" CodeFile="CadastroEspacoEsportivo.aspx.cs" Inherits="Pags_CadastroEspacoEsportivo" %>
                ...
                <div class="row">
                        ...
                        <div>
                            <nav class="text-center">
                                <ul style="list-style-type: none">
                                    <li>
                                        <a style="text-decoration: none" class="botaoEnviar" href="TipoCadastro.aspx">Voltar</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="text-center">
                            <asp:LinkButton runat="server" CssClass="botaoEnviar" OnClick="BtnCadastrar_Click" ID="BtnCadastrar" Text="Cadastrar" />
                        </div>
                    </div>
                </div>
            </section>
