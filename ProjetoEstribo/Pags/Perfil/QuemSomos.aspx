<%@ Page Title="" Language="C#" MasterPageFile="~/Pags/Perfil/MasterPerfil.master" AutoEventWireup="true" CodeFile="QuemSomos.aspx.cs" Inherits="pg_Perfil_QuemSomos" %>
                            ...
                            <nav>
                                <ul class="text-center" style="list-style-type: none">
                                    <li>
                                        ...
                                        <a style="text-decoration: none" class="botaoPadrao" href="EsportistaPerfil.aspx">Enviar</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
