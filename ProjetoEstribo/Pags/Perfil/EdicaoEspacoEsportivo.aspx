<%@ Page Title="" Language="C#" MasterPageFile="~/Pags/Perfil/MasterEspaco.master" AutoEventWireup="true" CodeFile="EdicaoEspacoEsportivo.aspx.cs" Inherits="Pags_Perfil_EdicaoEspacoEsportivo" %>
    ...
    <main class="container">
        <div class="row">            
            <div class="col-12">
                <br />
                <br />
                <h3 class="text-center">Escolha os esportes que seu Local oferece!</h3>
                <br />
                <br />
                            ...
                            <section class="Propartidas">
                                <div>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <h4 class="nomeOutros">Esportes Oferecidos</h4>
                                            </td>
                                        </tr>
                                    </table>
                                    <div data-spy="scroll" data-target="#navbarVertical" data-offset="0" class="TodosEventos">
                                        ...
                                        <!--CARD QUANDO O LOCAL ESPORTIVO NÃO CADASTROU NENHUM ESPORTE-->
                                        <div class="row">
                                ...
                                <table class="col-12">
                                    <tr>
                                        <td class="col-6, text-center">
                                            <asp:LinkButton runat="server" href="EspacoPerfil.aspx" CssClass="botaoPadrao" Text="Concluir" ID="BtnConcluir" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
